...
const ProfileViewer = ({userData, viewerButtonHandler}) => {
    ...
    const birthDate = chandeDateFormat(storeBirthDate);
    return (
...
const ProfileChanger = ({userData, viewerButtonHandler}) => {
    ...
    const profileChangerHandler = () => {
        viewerButtonHandler();
        dispatch(changeProfileData(nameRef.current.value, surNameRef.current.value, birthDateRef.current.value, gender, showDataCheckbox.current.checked))
    }
